                  ...
                  <div className="col-sm-12 col-md-6 order-1 order-sm-1 order-md-2">
                    <div className="work_head_rht">
                      <Image width={492} height={300}
                        src={require('../../../public/assets/images/HIRE US/Hire Web Developer/Hire PHP Developer/work-hand/Device-Image-6-1536x948.webp')}
              ...
              <div className="work_head_box port_webdevelopone">
                ...
                <div className="row w-100">
                  ...
                  <div className="col-sm-12 col-md-6 order-1 order-sm-1 order-md-2">
                    <div className="work_head_rht">
                      <Image width={492} height={300}
                        src={require('../../../public/assets/images/HIRE US/Hire Web Developer/Hire PHP Developer/work-hand/Device-Image-7-1536x948.webp')}
              ...
              <div className="work_head_box port_webdevelopsevan">
                ...
                <div className="row w-100">
                  ...
                  <div className="col-sm-12 col-md-6 order-1 order-sm-1 order-md-2">
                    <div className="work_head_rht">
                      <Image width={492} height={300}
                        src={require('../../../public/assets/images/HIRE US/Hire Web Developer/Hire PHP Developer/work-hand/Device-Image-3.webp')}
