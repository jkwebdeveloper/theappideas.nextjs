...
const ServiceProvideData = [
  {
    ...
    que: "SEO Consultancy",
    ans: "SEO which is also known as Search Engine Optimization which is one of the most demanding and popular services.SEO is free traffic generating process that is very helpful in increasing the engagement of the users towards the business. If you want to drive organic traffic then go for SEO.",
  ...
  },
  {
    ...
    ans: "Software solutions are one of the most popular ways of making a business successful and also to stand out differently in the market. Due to the high competition, you need to offer the best solutions as well as you also need to work on digital marketing for generating traffic.",
  ...
  },
  {
    ...
    ans: "If you have online platforms for your business then it is very important for you to know everything about the websites including the Digital marketing services. Sometimes due to some reasons, the website can be blocked or can be penalised for some reasons.",
  ...
  },
  {
    ...
    ans: "If we discuss digital marketing then this is probably one of the best services for the growth of the business. Many people are now planning of making investments in digital marketing for promoting their services and increasing the customer base of the users.",
  ...
  },
  {
    ...
    ans: "Nowadays, the demand for content marketing is one of the most popular factors for promoting any kind of business and service at the best possible rates. Content is highly demanding in the market because this will help your business to reach out to the targeted audience and attract new customers.",
...
const IndustriesData = [
  {
    ...
    ans: "The demand for online platforms is increasing day by day. Many of the business owners are now planning of making investments in digital platforms for making the business more popular.SEO(Search Engine Optimization) is very helpful in getting the attention of new users into your websites",
  ...
  },
  {
    ...
    ans: "As per the increasing demand for software solutions, the demand for software development services is also increasing with the increasing popularity. If you already own a website then it is very important for you to work on digital marketing to promote your services in the business.",
    ans2: "The App Ideas is one of the most popular software development company. We offer web apps, websites and mobile app development. We offer SEO services at a highly competitive price and even remain approachable and accessible for startups and small enterprise websites.",
  },
  {
    id: 4,
    ...
    ans: "If we talk about the demand for digital marketing then digital marketing is one of the most popular as well as demanding services in the market. Content Marketing is one of the most important parts of digital marketing. This can help businesses to stand out differently among their competitors.",
  ...
  },
  {
    ...
    ans: "Digital marketing is very helpful in this present time as well as also for the future. To beat up the high competition, it is very important for you to have the best online platform as well as the best team of digital marketing who will deliver the project on time and drive better results.",
  ...
  },
  {
    ...
    ans: "If you own a business online platform then it is very important for you to hire the best digital marketing team who will offer continuous support and helps in increasing the engagement of the customers or users. Digital marketing is very important for business growth.",
  ...
  return (
    <>
      ...
      <HeroSection
        ...
        des="A mobile app for your business or organization is essential nowadays. More business owners and entrepreneurs are investing in digital platforms, making app launch vital. ASO is essential for app visibility. The App Ideas has competitive ASO rates. We optimize your app for app store visibility and reach. Partner with us to develop your app's digital market."
      ...
      <section className="service__provide__section py-5">
        <div className="container">
          <div className="Title">
            ...
            <p>
              ASO strategically increases mobile app exposure across OS
              platforms. Keywords, descriptions, and photos are optimized by ASO
              to increase mobile app store downloads. As a leading app
              development and marketing company, App Ideas has a qualified and
              driven ASO workforce. Several mobile apps in numerous categories
              have gained exposure and momentum via diligent optimization. Using
              our ASO knowledge, we build app performance strategies to succeed
              in the competitive app market. Work with us to promote your mobile
              app.
            </p>
          </div>
