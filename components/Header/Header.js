                      ...
                      <Link href="/our-process/">
                        ...
                        >
                          ...
                          <Image
                            ...
                            width={36}
                            height={36}
                            alt="Our-Team" className="img-fluid"
                          />{" "}
                          Our Process
                        </li>
                      </Link>
                      ...
                      <Link href="/testimonial/">
                        ...
                        >
                          ...
                          <Image
                            ...
                            width={36}
                            height={36}
                            alt="Testamonials" className="img-fluid"
                          />
                          Testimonial
                        </li>
                      </Link>
                      ...
                      <Link href="/careers/">
                        ...
                        >
                          ...
                          <Image
                            ...
                            width={36}
                            height={36}
                            alt="Carrers" className="img-fluid"
                          />{" "}
                          Careers
                        </li>
                      </Link>
                      ...
                      <Link href="/life-at-tai/">
                        ...
                        >
                          ...
                          <Image
                            ...
                            width={36}
                            height={36}
                            alt="Life-at-TAI" className="img-fluid"
                          />{" "}
                          Life at TAI
                        </li>
                      </Link>
                ...
                <div className="content">
                  <div className="row">
                    ...
                    >
                      <h4>
                        {" "}
                        <Image width={36} height={36} className="img-fluid"
                    ...
                    >
                      <h4>
                        ...
                        <Image width={36} height={36}
                          ...
                          alt="Digital-Marketing-Agency" className="img-fluid"
                        />{" "}
          ...
          {openmenu ? (
            <div className="header_mobile_menu header_menu_lft">
              <div className="header_mobile_top">
                ...
                >
                  <Image width={120} height={45} className="img-fluid"
                    src={require("../../public/assets/images/Header/logo.png")}
                    alt="logo"
                    // style={{ height: '60px ' }}
                  />
                    ...
                    <li className="nav_ul_li">
                      ...
                      {openCategory === "service" ? (
                        <ul className="sub-menu" id="sub-menu">
                          ...
                          <li>
                            <Link href="/designing-services">DESIGNING SERVICES</Link>
